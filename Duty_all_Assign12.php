  ...
  <form action="#" method="POST">
	<div class="container content">
			...
			<h4>Please fill out the details to continue...</h4>
				...
				<div class="input-group mb-3">
					<input type="submit" onclick='return dutymessage()' name="register" class="btn btn-default" value="Submit">
				</div>
			</div>
		</div>
  </form>
...
<footer id="footer">
  ...
  if($_POST['register'])
  {
    ...
    $police_id =  $_POST['police_id'];
      ...
      $checkDuty=" select date from dutytable1 where police_id='$police_id' and date='$date'";
      $chkFinal=mysqli_query($conn,$checkDuty);
      if($checkDuty==null)
{
