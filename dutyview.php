...
<?php
    while($result = mysqli_fetch_assoc($data))
    {
        ...
        <td><a href='Dutyupdate.php?id=$result[police_id]'> Update</a></td>
        <td><a href='dutyview.php?police_id=".$result['police_id']."' id='btn' onclick='return checkdelete()' >Delete</a></td> 
