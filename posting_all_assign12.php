  ...
  <form action="#" method="post">
	<div class="container content">
			...
			<h4>Please fill out the details to continue...</h4>
				...
				<div class="input-group mb-3">
                <input type="submit" onclick='return postingmessage()' name="register" class="btn btn-default" value="Submit">
				</div>
			</div>
		</div>
  </form>
...
<footer id="footer">
  ...
  if($_POST['register'])
  {
    ...
    $police_id =  $_POST['police_id'];
      ...
      $query=" INSERT INTO postingtable values (' $full_name',' $police_id',' $station_name',' $area',' $date',' $start_time',' $start_time')";
