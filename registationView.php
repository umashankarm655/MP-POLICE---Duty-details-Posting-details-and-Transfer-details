...
<h2> Display All Registered Data<h2>
...
<?php
    while($result = mysqli_fetch_assoc($data))
    {
        ...
        <td>".$result['pass']."</td>
<td><a href='registationUpdate.php?id=$result[police_id]'> Update</a></td>
<td><a href='registationView.php?police_id=".$result['police_id']."' id='btn' onclick='return checkdelete()' >Delete</a></td> 
    </tr>
    ";
    }
}
