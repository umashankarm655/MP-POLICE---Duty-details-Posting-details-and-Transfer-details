...
<div class="container">
  ...
  <p id="message"></p>
    ...
    <!-- <div class="form-group">
		<label for="pwd">senderid:</label>
		<input type="number" name="senderid" class="form-control" id="senderid" placeholder="Enter sender No"  >
    </div> -->
    <div class="form-group">
		<label for="pwd">Mobile No.:</label>
		<input type="number" name="mno" class="form-control" id="mobile" placeholder="Enter Mobile No"  >
    </div>
    <div class="form-group">
		<label for="comment">Message:</label>
		<textarea class="form-control" rows="5" id="message" name="msg" placeholder="Write Your <!DOCTYPE html>
<html lang="en">
...
$query_run= mysqli_query($connection, $query);
    ...
    <!-- footer -->Message Here...."></textarea>
	</div>
    <button type="submit" name="ok" class="btn btn-primary" id="send">Send Message</button>
    </form>
</div>
 <!-- <script>
	$("send").click(function(){
